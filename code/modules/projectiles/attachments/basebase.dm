/obj/item/gun_attachment/base
	...
	not_okay = /obj/item/gun_attachment/base

/obj/item/gun_attachment/base/on_attach(var/obj/item/gun/owner)
	..()
	if(owner.chambered)
	...
	switch(gun_type)
		if(CUSTOMIZABLE_REVOLVER)
			var/obj/item/gun/ballistic/O = owner
			O.mag_type = mag_type
			if(internal)
...
/obj/item/gun_attachment/base/on_remove(var/obj/item/gun/owner)
	..()
	switch(gun_type)
